                ...
                <div class="col-8">
                    <div class="row">
                        <div class="  d-flex justify-content-end">
                            ...
                            <a href="/cart" class="text-black me-3">
                ...
                <div class="row d-flex justify-content-around">
                    ...
                    <form action="{{route('dashboard')}}" method="GET" role="search" class="col-8">
                        <div class="input-group  mt-1">
                            <input type="text" class="form-control m-auto" name="search"
                                   placeholder="Search products" value="{{ request()->query('search') }}">
                            <button type="submit" class="btn  input-group-btn btn-default bg-dark">
                            ...
                            <div class="offcanvas-body p-0">
                                <nav class="navbar-dark">
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="mx-2  {{ (request()->is('/')) ? 'bg-opacity-50 bg-secondary rounded' : '' }}">
                                            <a href="/"
                                               class="nav-link px-3 {{ (request()->is('/')) ? 'active' : '' }}">
                                        ...
                                        <li class="mx-2 {{ (request()->is('goods*')) ? 'bg-opacity-50 bg-secondary rounded' : '' }}">
                                            <a href="{{route('goods.index')}}"
                                               class="nav-link px-3 {{ (request()->is('goods*')) ? 'active' : '' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <li class="mx-2 {{ (request()->is('orders*')) ? 'bg-opacity-50 bg-secondary rounded' : '' }}">
                                            <a href="/orders"
                                               class="nav-link px-3 {{ (request()->is('orders*')) ? 'active' : '' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <li class="mx-2 {{ (request()->is('payments*')) ? 'bg-opacity-50 bg-secondary rounded' : '' }}">
                                            <a href="/payments"
                                               class="nav-link px-3 {{ (request()->is('payments*')) ? 'active' : '' }}">
                                        ...
                                        <li class="mx-2 {{ (request()->is('users*')) ? 'bg-opacity-50 bg-secondary rounded' : '' }}">
                                            <a href="/users"
                                               class="nav-link px-3 {{ (request()->is('users*')) ? 'active' : '' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <li class="mx-2 {{ (request()->is('voucher*')) ? 'bg-opacity-50 bg-secondary rounded' : '' }}">
                                            <a href="/voucher"
                                               class="nav-link px-3 {{ (request()->is('voucher*')) ? 'active' : '' }}">
            ...
            <div class="col-4 bg-light p-0">
                <div class="text-secondary row">
                    ...
                    <ul class="nav nav-pills flex-column">
                        ...
                        <li class="ps-4 nav-item">
                            <a class="text-black" href="/customer">Profile</a>
                        </li>
                        <li class="ps-4 nav-item">
