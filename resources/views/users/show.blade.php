                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="text" class="form-control" name="password" value="{{$user->password}}" required autofocus disabled>
                                <div class="collapse" id="collapse-price">
                                    <p class="text-muted"><small>This value entered in this field will be displayed as the password.</small></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row my-2">
                            <div class="col-md-4 col-form-label text-md-right d-flex justify-content-between">
                                <label for="owner_id">{{ __('Owner ID') }}</label>
                            ...
                            <div class="col-md-6">
                                <div class="col-md-6">
                                    <input id="owner_id" type="text" class="form-control" name="owner_id" value="{{$user->owner_id}}" required autofocus disabled>
                                    <div class="collapse" id="collapse-price">
                                        <p class="text-muted"><small>This value entered in this field will be displayed as the owner ID.</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
