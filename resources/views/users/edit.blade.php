            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header d-flex justify-content-between">
                        <div class="my-auto">
                            <h5 class="d-inline">{{ __('Edit User Details') }}</h5>
                            <small class="text-muted d-inline"> (Edit details of good - <i>{{$user->username}}</i>)</small>
                        </div>
                        <div>
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="collapse" id="collapse-price">
                                    <p class="text-muted"><small>This value entered in this field will be displayed as
                                            the password. Make it hard.</small></p>
                                </div>
                            </div>
                        </div>
                    </div>
