            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header d-flex justify-content-between">
                        <div class="my-auto">
                            <h5 class="d-inline">{{ __('Create User') }}</h5>
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="collapse" id="collapse-description">
                                    <p class="text-muted"><small>This value entered in this field will be displayed as the email address. Please provide correct email address so customer can receive it successfully.</small></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="collapse" id="collapse-price">
                                    <p class="text-muted"><small>This value entered in this field will be displayed as the password. Make sure it is hard enough to guess.</small></p>
                                </div>
                            </div>
                        </div>
                    </div>
