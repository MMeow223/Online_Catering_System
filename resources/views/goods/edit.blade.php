                                ...
                                @else
                                    @foreach($varieties as $variety)
                                        <div class="form-check form-check-inline py-2">
                                            <input name="variety-checkbox-{{$variety->id}}" class="form-check-input" type="checkbox" id="variety-checkbox-{{$variety->id}}" value="1" @if($variety->is_available) checked @endif>
                                    ...
                                    <input id="new_variety" type="text" class="form-control" name="new_good_variety" placeholder='Separate each varieties with comma ","' style="display: none">
