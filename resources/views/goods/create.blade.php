                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group col-md-6" role="group" aria-label="Basic radio toggle button group">
                                    <input type="radio" class="btn-check" name="food_type_option" value=1 id="warm_outlined" autocomplete="off">
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="new_good_variety" placeholder='Separate each varieties with comma "," '>
                                <div class="collapse" id="collapse-good-variety">
                                    <p class="text-muted"><small>These are the options for the customer. They can choose the food based on these varieties.</small></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group col-md-6" role="group" aria-label="Basic radio toggle button group">
                                    <input type="radio" class="btn-check" name="availability_option" value=1 id="available_outlined" autocomplete="off">
                                    <label class="btn btn-outline-success" for="available_outlined">{{__('Available')}}</label>

                                    <input type="radio" class="btn-check" name="availability_option" value=0 id="not_available_outlined" autocomplete="off">
