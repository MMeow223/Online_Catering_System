            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="my-auto">{{ __('Payment Details') }}</h5>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-6">
                                <input id="method" type="text" class="form-control" name="name" value="{{$good->good_name}}" required autofocus disabled>
                        ...
                        <div class="form-group row my-2">
                            <div class="col-md-4 col-form-label text-md-right d-flex justify-content-between">
                                <label for="accountno">{{ __('Account Number') }}</label>
                            ...
                            <div class="col-md-6">
                                <input id="accountno" type="text" class="form-control" name="description" value="{{$good->good_description}}" required autofocus disabled>
                        ...
                        <div class="form-group row my-2">
                            <div class="col-md-4 col-form-label text-md-right d-flex justify-content-between">
                                <label for="transid">{{ __('Transaction ID') }}</label>
                            ...
                            <div class="col-md-6">
                                <input id="transid" type="text" class="form-control" name="transid" value="{{$good->good_price}}" required autofocus disabled>
                                <div class="collapse" id="collapse-price">
                                    <p class="text-muted"><small>Transaction id of the payment</small></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-6">
                                <select id="total_amount" class="form-control" name="category_id" required disabled>
